...
namespace HeuristicCalculator
{
    public class Heuristic
    {
        ...
        public class winningBits
        {
            public int[] bits = new int[4];
            public bool[] bitWon = new bool[4];
        }
        ...
        public static byte flipPieceBits(byte piece)
        {
            var pieceBit = 0;
            byte newPiece;
            for (int k = 3; k >= 0; k--)
        ...
        public static winningBits findWinningBit(string[] gameBoard, string pieceToPlay, int boardPosition)
        {
            byte pieceBinary;
            byte[] pieces = new byte[16];
            winningBits winningBitValues = new winningBits();
            ...
            if (boardPosition == 0 || boardPosition == 1 || boardPosition == 2 || boardPosition == 3)
            {
                winningBitValues = checkWinBit(pieces[0], pieces[1], pieces[2], pieces[3], 0, winningBitValues, pieceBinary, 1);
                winningBitValues = checkWinBit(pieces[0], pieces[1], pieces[2], pieces[3], 0, winningBitValues, pieceBinary, 0);
            }
            if (boardPosition == 4 || boardPosition == 5 || boardPosition == 6 || boardPosition == 7)
            {
                winningBitValues = checkWinBit(pieces[4], pieces[5], pieces[6], pieces[7], 1, winningBitValues, pieceBinary, 1);
                winningBitValues = checkWinBit(pieces[4], pieces[5], pieces[6], pieces[7], 1, winningBitValues, pieceBinary, 0);
            }
            if (boardPosition == 8 || boardPosition == 9 || boardPosition == 10 || boardPosition == 11)
            {
                winningBitValues = checkWinBit(pieces[8], pieces[9], pieces[10], pieces[11], 2, winningBitValues, pieceBinary, 1);
                winningBitValues = checkWinBit(pieces[8], pieces[9], pieces[10], pieces[11], 2, winningBitValues, pieceBinary, 0);
            }
            if (boardPosition == 12 || boardPosition == 13 || boardPosition == 14 || boardPosition == 15)
            {
                winningBitValues = checkWinBit(pieces[12], pieces[13], pieces[14], pieces[15], 3, winningBitValues, pieceBinary, 1);
                winningBitValues = checkWinBit(pieces[12], pieces[13], pieces[14], pieces[15], 3, winningBitValues, pieceBinary, 0);
            }
            if (boardPosition == 0 || boardPosition == 4 || boardPosition == 8 || boardPosition == 12)
            {
                winningBitValues = checkWinBit(pieces[0], pieces[4], pieces[8], pieces[12], 4, winningBitValues, pieceBinary, 1);
                winningBitValues = checkWinBit(pieces[0], pieces[4], pieces[8], pieces[12], 4, winningBitValues, pieceBinary, 0);
            }
            if (boardPosition == 1 || boardPosition == 5 || boardPosition == 9 || boardPosition == 13)
            {
                winningBitValues = checkWinBit(pieces[1], pieces[5], pieces[9], pieces[13], 5, winningBitValues, pieceBinary, 1);
                winningBitValues = checkWinBit(pieces[1], pieces[5], pieces[9], pieces[13], 5, winningBitValues, pieceBinary, 0);
            }
            if (boardPosition == 2 || boardPosition == 6 || boardPosition == 10 || boardPosition == 14)
            {
                winningBitValues = checkWinBit(pieces[2], pieces[6], pieces[10], pieces[14], 6, winningBitValues, pieceBinary, 1);
                winningBitValues = checkWinBit(pieces[2], pieces[6], pieces[10], pieces[14], 6, winningBitValues, pieceBinary, 0);
            }
            if (boardPosition == 3 || boardPosition == 7 || boardPosition == 11 || boardPosition == 15)
            {
                winningBitValues = checkWinBit(pieces[3], pieces[7], pieces[11], pieces[15], 7, winningBitValues, pieceBinary, 1);
                winningBitValues = checkWinBit(pieces[3], pieces[7], pieces[11], pieces[15], 7, winningBitValues, pieceBinary, 0);
            }
            if (boardPosition == 0 || boardPosition == 5 || boardPosition == 10 || boardPosition == 15)
            {
                winningBitValues = checkWinBit(pieces[0], pieces[5], pieces[10], pieces[15], 8, winningBitValues, pieceBinary, 1);
                winningBitValues = checkWinBit(pieces[0], pieces[5], pieces[10], pieces[15], 8, winningBitValues, pieceBinary, 0);
            }
            if (boardPosition == 3 || boardPosition == 6 || boardPosition == 9 || boardPosition == 12)
            {
                winningBitValues = checkWinBit(pieces[3], pieces[6], pieces[9], pieces[12], 9, winningBitValues, pieceBinary, 1);
                winningBitValues = checkWinBit(pieces[3], pieces[6], pieces[9], pieces[12], 9, winningBitValues, pieceBinary, 0);
            }

            return winningBitValues;
        }

        public static winningBits checkWinBit(byte piece1, byte piece2, byte piece3, byte piece4, int rowNumber, winningBits winningBitValues, byte pieceBinary, int oddBit)
        {
            var slot1 = 0;
            var slot2 = 0;
            var slot3 = 0;
            ...
            int nullPieceCount = 0;
            int[] nullValues = { nullPiece, nullPieceCount };
            nullValues = countNullPieces(piece1, piece2, piece3, piece4);
            ...
            else
            {
                ...
                for (int k = 3; k >= 0; k--)
                {
                    ...
                    if ((slot1 % 2 == oddBit && slot2 % 2 == oddBit && slot3 % 2 == oddBit && potentialSlot % 2 == oddBit)
                        || (slot1 % 2 == oddBit && slot2 % 2 == oddBit && slot4 % 2 == oddBit && potentialSlot % 2 == oddBit)
                        || (slot1 % 2 == oddBit && slot3 % 2 == oddBit && slot4 % 2 == oddBit && potentialSlot % 2 == oddBit)
                        || (slot2 % 2 == oddBit && slot3 % 2 == oddBit && slot4 % 2 == oddBit && potentialSlot % 2 == oddBit))
                    {
                        winningBitValues.bits[j] = potentialSlot % 2;
                        winningBitValues.bitWon[j] = true;
                    }
                    j++;
                }
            }
