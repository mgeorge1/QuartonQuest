...
// Source: https://github.com/LiberalMiser/Smooth-Unity-Orbit-Camera-Script
...
public class CameraMotionControls : MonoBehaviour {
    ...
    public float startRotationY = 180;
    [Tooltip("The rotation along the x-axis the camera will have at start.")]
    public float startRotationX = 180;
    ...
    [Tooltip("The position along the Z-axis the camera game object starts at.")]
    public float zAxisStartingDistance = 25f;
    [Header("Zooming")]
